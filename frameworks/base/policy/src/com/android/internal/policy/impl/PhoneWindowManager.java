...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    //int mDefaultOrientation = Surface.ROTATION_0; //crewrktablets
    ...
    public void init(Context context, IWindowManager windowManager,
        ...
        //mDefaultOrientation = Integer.parseInt(SystemProperties.get("ro.orientation","0")); //crewrktablets
        ...
        synchronized (mLock) {
            ...
            switch (orientation) {
                ...
                default:
                    ...
                    return Surface.ROTATION_0;
                    //return mDefaultOrientation; //crewrktalets
            }
        }
    }
